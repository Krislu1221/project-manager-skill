...
description: "项目上下文隔离与状态管理系统 v2.5。核心解决：对话中遗忘、跨天上下文丢失、新话题漏记录。新增：甘特图自动生成、项目风险自动识别、依赖关系管理。触发词: /project, 新建项目, 项目列表, 甘特图, 时间线, 进度图, 风险扫描, 检查风险"
---
...
### 触发词
`/project` | `新建项目` | `项目列表` | `甘特图` | `时间线` | `进度图` | `风险扫描` | `检查风险`
